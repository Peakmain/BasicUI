package com.peakmain.ui.keyboard.system;
...
public class Keyboard {
    ...
    public static class Row {
        ...
        public Row(Resources res, Keyboard parent, XmlResourceParser parser) {
            ...
            TypedArray a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    R.styleable.System_Keyboard);
            defaultWidth = getDimensionOrFraction(a,
                    R.styleable.System_Keyboard_android_keyWidth,
                    parent.mDisplayWidth, parent.mDefaultWidth);
            defaultHeight = getDimensionOrFraction(a,
                    R.styleable.System_Keyboard_android_keyHeight,
                    parent.mDisplayHeight, parent.mDefaultHeight);
            defaultHorizontalGap = getDimensionOrFraction(a,
                    R.styleable.System_Keyboard_android_horizontalGap,
                    parent.mDisplayWidth, parent.mDefaultHorizontalGap);
            verticalGap = getDimensionOrFraction(a,
                    R.styleable.System_Keyboard_android_verticalGap,
                    parent.mDisplayHeight, parent.mDefaultVerticalGap);
            a.recycle();
            a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    R.styleable.System_Keyboard_Row);
            rowEdgeFlags = a.getInt(R.styleable.System_Keyboard_Row_android_rowEdgeFlags, 0);
            mode = a.getResourceId(R.styleable.System_Keyboard_Row_android_keyboardMode,
                    0);
        }
    }
    ...
    public static class Key {
        ...
        public Key(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            ...
            a.recycle();
            a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    R.styleable.System_Keyboard_Key);
            this.x += gap;
            TypedValue codesValue = new TypedValue();
            a.getValue(R.styleable.System_Keyboard_Key_android_codes,
                    codesValue);
            ...
            iconPreview = a.getDrawable(R.styleable.System_Keyboard_Key_android_iconPreview);
            if (iconPreview != null) {
                iconPreview.setBounds(0, 0, iconPreview.getIntrinsicWidth(),
                        iconPreview.getIntrinsicHeight());
            }
            popupCharacters = a.getText(
                    R.styleable.System_Keyboard_Key_android_popupCharacters);
            popupResId = a.getResourceId(
                    R.styleable.System_Keyboard_Key_android_popupKeyboard, 0);
            repeatable = a.getBoolean(
                    R.styleable.System_Keyboard_Key_android_isRepeatable, false);
            modifier = a.getBoolean(
                    R.styleable.System_Keyboard_Key_android_isModifier, false);
            sticky = a.getBoolean(
                    R.styleable.System_Keyboard_Key_android_isSticky, false);
            edgeFlags = a.getInt(R.styleable.System_Keyboard_Key_android_keyEdgeFlags, 0);
            edgeFlags |= parent.rowEdgeFlags;

            icon = a.getDrawable(
                    R.styleable.System_Keyboard_Key_android_keyIcon);
            if (icon != null) {
                icon.setBounds(0, 0, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
            }
            label = a.getText(R.styleable.System_Keyboard_Key_android_keyLabel);
            text = a.getText(R.styleable.System_Keyboard_Key_android_keyOutputText);
