...
import com.peakmain.ui.keyboard.system.Keyboard.Key;
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private static final int[] LONG_PRESSABLE_STATE_SET = {R.styleable.System_KeyboardViewPreviewState_android_state_long_pressable};
...
//    private AccessibilityManager mAccessibilityManager;
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.System_KeyboardView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.System_KeyboardView_android_keyBackground) {
                mKeyBackground = a.getDrawable(attr);
            } else if (attr == R.styleable.System_KeyboardView_android_verticalCorrection) {
                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
            } else if (attr == R.styleable.System_KeyboardView_android_keyPreviewLayout) {
                previewLayout = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.System_KeyboardView_android_keyPreviewOffset) {
                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
            } else if (attr == R.styleable.System_KeyboardView_android_keyPreviewHeight) {
                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
            } else if (attr == R.styleable.System_KeyboardView_android_keyTextSize) {
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
            } else if (attr == R.styleable.System_KeyboardView_android_keyTextColor) {
                mKeyTextColor = a.getColor(attr, 0xFF000000);
            } else if (attr == R.styleable.System_KeyboardView_android_labelTextSize) {
                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
            } else if (attr == R.styleable.System_KeyboardView_android_popupLayout) {
                mPopupLayout = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.System_KeyboardView_android_shadowColor) {
                mShadowColor = a.getColor(attr, 0);
            } else if (attr == R.styleable.System_KeyboardView_android_shadowRadius) {
