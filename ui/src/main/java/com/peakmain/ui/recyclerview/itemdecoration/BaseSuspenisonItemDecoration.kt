...
abstract class BaseSuspenisonItemDecoration<T : GroupRecyclerBean<*>?> : RecyclerView.ItemDecoration {
    ...
    constructor(context: Context?, data: List<T>) {
        ...
        topHeight = dp2px(10f)
        mTextSize = dp2px(10f)
        mTextColor = ContextCompat.getColor(context, com.peakmain.ui.R.color.color_4A4A4A)
    ...
    constructor(builder: Builder<T>) {
        ...
        mTextColor = if (builder.mTextColor != 0) builder.mTextColor else ContextCompat.getColor(builder.mContext, com.peakmain.ui.R.color.color_4A4A4A)
