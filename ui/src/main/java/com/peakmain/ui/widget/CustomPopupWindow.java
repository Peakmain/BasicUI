...
public class CustomPopupWindow implements PopupWindow.OnDismissListener {
    ...
    public CustomPopupWindow setBackgroundDark() {
    ...
    public static class PopupWindowBuilder {
        ...
        public PopupWindowBuilder setOnClickListener(int id, View.OnClickListener onClickListener) {
            mCustomPopupWindow.getPopupWindow()
                    .getContentView()
                    .findViewById(id)
        ...
        public PopupWindowBuilder getView(int id) {
            mCustomPopupWindow.mContentView.findViewById(id);
            return this;
        }
