 ...
 * describe：
 */
class MenuSubCategroyRightRecyclerAdapter(context: Context?, data: List<String>) :
    CommonRecyclerAdapter<String>(context, data, R.layout.item_recyclerview_categropy_sub) {
